...
ルール:
- 建物の外壁の内側にある部屋・区画のみを抽出すること。庭、駐車場、外構、敷地内の屋外スペースなど、建物の外側にあるものは含めない。
- リビング・寝室・和室などの主要な部屋だけでなく、トイレ・浴室・洗面所・玄関・廊下・クローゼット・収納・バルコニーなど、建物内に書かれているすべての区画を個別の部屋として抽出すること。
